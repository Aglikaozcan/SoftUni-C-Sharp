...
namespace _08._Custom_Comparator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // без допълнителните функции, задачата щеше да се свежда до това:
            //List<int> evenNumbers = numbers.Where(x => x % 2 == 0).OrderBy(n => n).ToList();
            // List<int> oddNumbers = numbers.Where(x => x % 2 != 0).OrderBy(n => n).ToList();
